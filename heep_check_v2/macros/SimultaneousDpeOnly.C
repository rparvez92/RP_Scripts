/*
  ...
  Run examples:
    root -l -b -q 'macros/SimultaneousDpeOnly.C("results/tables/MeasuredOffsetsBySetting.csv","")'
*/
...
void SimultaneousDpeOnly(const char* inCsv = "results/tables/MeasuredOffsetsBySetting.csv",
                         const char* outCsv = "") {
  ...
  if (outPath.empty()) {
    outPath = "results/tables/SimultaneousDpeOnly.csv";
  }
