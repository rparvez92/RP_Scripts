#!/usr/bin/env python3
"""
generate_settings_tree_v5.py

Run command example:
  python3 generate_settings_tree_v5.py \
    --bigtable /path/to/rsidis_bigtable_pass0.csv \
    --outdir   /path/to/rsidis_xs_v5/settings \
    --targets  LH2 LD2
...
def main() -> int:
    ...
    ap.add_argument("--outdir", required=True, help="Output settings directory")
    ...
    for k, g in df_e_settings.groupby(group_cols, dropna=False):
        ...
        lines = []
        lines.append("Setting directory generated by generate_settings_tree_v5.py")
