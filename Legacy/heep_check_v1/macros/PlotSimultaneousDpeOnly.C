...
//
//   results/PNGs/PlotSimultaneousDpeOnly/<Constrained,Unconstrained>/setting<A,B>_kinOffsets.png
//   results/PNGs/PlotSimultaneousDpeOnly/<Constrained,Unconstrained>/setting<A,B>_residuals.png
//   results/PNGs/PlotSimultaneousDpeOnly/<Constrained,Unconstrained>/setting<A,B>_chi2ndf.png
//
// Plot types:
...
//   constrained:
//     results/tables/SimultaneousDpeOnly_constrained.csv
//     results/PNGs/PlotSimultaneousDpeOnly/Constrained
//
//   unconstrained:
//     results/tables/SimultaneousDpeOnly_unconstrained.csv
//     results/PNGs/PlotSimultaneousDpeOnly/Unconstrained
//
// Example:
//   root -l -b -q 'macros/PlotSimultaneousDpeOnly.C("constrained")'
//   root -l -b -q 'macros/PlotSimultaneousDpeOnly.C("unconstrained")'
//   root -l -b -q 'macros/PlotSimultaneousDpeOnly.C("constrained","results/tables/SimultaneousDpeOnly_constrained.csv","results/PNGs/PlotSimultaneousDpeOnly/Constrained")'
...
static void MakeOffsetsCanvas(const std::string& setting,
  ...
  TCanvas* c = new TCanvas(Form("c_sim_kin_%s_%s", setting.c_str(), modeLabel.c_str()),
...
static void MakeResidualsCanvas(const std::string& setting,
                                ...
                                const std::string& outDir,
                                const std::string& modeLabel) {
  TCanvas* c = new TCanvas(Form("c_sim_res_%s_%s", setting.c_str(), modeLabel.c_str()),
...
static void MakeChi2Canvas(const std::string& setting,
                           ...
                           const std::string& outDir,
                           const std::string& modeLabel) {
  TCanvas* c = new TCanvas(Form("c_sim_chi2_%s_%s", setting.c_str(), modeLabel.c_str()),
...
void PlotSimultaneousDpeOnly(const char* modeIn = "unconstrained",
                             const char* inCsvIn = "",
                             const char* outDirIn = "") {
  ...
  if (inCsv.empty()) {
    inCsv = "results/tables/SimultaneousDpeOnly_" + mode + ".csv";
  }

  std::string outDir = Trim(outDirIn ? outDirIn : "");
  if (outDir.empty()) {
    outDir = "results/PNGs/PlotSimultaneousDpeOnly/" + modeDir;
  }
