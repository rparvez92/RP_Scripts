/*
  ...
  Run examples:
    root -l -b -q 'macros/SimultaneousDpeDthe.C("results/tables/MeasuredOffsetsBySetting.csv","")'
*/
...
void SimultaneousDpeDthe(const char* inCsv = "results/tables/MeasuredOffsetsBySetting.csv",
                         const char* outCsv = "") {
  ...
  if (outPath.empty()) {
    outPath = "results/tables/SimultaneousDpeDthe.csv";
  }
