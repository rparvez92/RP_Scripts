...
//
//   results/PNGs/PlotSimultaneousDpeOnly/setting<A,B>_kinOffsets.png
//   results/PNGs/PlotSimultaneousDpeOnly/setting<A,B>_residuals.png
//   results/PNGs/PlotSimultaneousDpeOnly/setting<A,B>_chi2ndf.png
//
// Plot types:
...
//
// This v2 copy is intended to be run from:
