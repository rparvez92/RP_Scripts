...
//
//   results/PNGs/PlotSimultaneousDpeDthe/setting<A,B>_kinOffsets.png
//   results/PNGs/PlotSimultaneousDpeDthe/setting<A,B>_residuals.png
//   results/PNGs/PlotSimultaneousDpeDthe/setting<A,B>_chi2ndf.png
//
// Plot types:
