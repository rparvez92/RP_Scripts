...
def main() -> None:
    ...
    ap.add_argument("--settings", required=True, help="settings root (e.g., rsidis_xs_v2/settings)")
    ap.add_argument("--results", required=True, help="results root (e.g., rsidis_xs_v2/results)")
