#!/usr/bin/env python3
"""
Combined4and5PassErrors_WithDe0PassDep.py

Toy-MC uncertainties for the combined 4+5-pass fit with pass-dependent de0
and one global dthp. This uses the exact same model as
Combined4and5PassFitParams_WithDe0PassDep.py.
...
Outputs:
  results/tables/Combined4and5PassWithDe0PassDep/Combined4and5PassErrors_WithDe0PassDep_toys.csv
  results/tables/Combined4and5PassWithDe0PassDep/Combined4and5PassErrors_WithDe0PassDep_params.csv
  results/tables/Combined4and5PassWithDe0PassDep/Combined4and5PassErrors_WithDe0PassDep_summary.csv
...
Run from heep_check_v3:
  python3 macros/Combined4and5PassErrors_WithDe0PassDep.py
"""
...
import Combined4and5PassFitParams_WithDe0PassDep as fitmod  # noqa: E402


BAD_BRANCH_ABS_PARAM_THRESHOLD = 5.0
OUT_DIR = Path("results/tables/Combined4and5PassWithDe0PassDep")
FITPARAMS_CSV = OUT_DIR / "Combined4and5PassFitParams_WithDe0PassDep.csv"
PARAMS_CSV = OUT_DIR / "Combined4and5PassErrors_WithDe0PassDep_params.csv"
TOYS_CSV = OUT_DIR / "Combined4and5PassErrors_WithDe0PassDep_toys.csv"
SUMMARY_CSV = OUT_DIR / "Combined4and5PassErrors_WithDe0PassDep_summary.csv"
RESIDUALS_CSV = OUT_DIR / "Combined4and5PassResiduals_WithDe0PassDep_WithToyErrors.csv"
...
def main() -> None:
    ...
    with summary_csv.open("w", newline="") as f:
        ...
        writer.writerow(["method", "combined_4and5_with_pass_dependent_de0_scipy_nelder_mead_toy_errors"])
    ...
    print(f"[INFO] combined 4+5 with pass-dependent de0 physical toy fraction: {float(np.mean(physical_mask)):.4f}")
