#!/usr/bin/env python3
"""
Combined4and5PassErrors_WithDe0.py

Toy-MC uncertainties for the combined 4+5-pass fit with one global de0 and
one global dthp. This uses the exact same model as
...
Outputs:
  results/tables/Combined4and5PassWithDe0/Combined4and5PassErrors_WithDe0_toys.csv
  results/tables/Combined4and5PassWithDe0/Combined4and5PassErrors_WithDe0_params.csv
  results/tables/Combined4and5PassWithDe0/Combined4and5PassErrors_WithDe0_summary.csv
  results/tables/Combined4and5PassWithDe0/Combined4and5PassResiduals_WithDe0_WithToyErrors.csv

Run from heep_check_v3:
  python3 macros/Combined4and5PassErrors_WithDe0.py
"""
...
import Combined4and5PassFitParams_WithDe0 as fitmod  # noqa: E402


BAD_BRANCH_ABS_PARAM_THRESHOLD = 5.0
OUT_DIR = Path("results/tables/Combined4and5PassWithDe0")
FITPARAMS_CSV = OUT_DIR / "Combined4and5PassFitParams_WithDe0.csv"
PARAMS_CSV = OUT_DIR / "Combined4and5PassErrors_WithDe0_params.csv"
TOYS_CSV = OUT_DIR / "Combined4and5PassErrors_WithDe0_toys.csv"
SUMMARY_CSV = OUT_DIR / "Combined4and5PassErrors_WithDe0_summary.csv"
RESIDUALS_CSV = OUT_DIR / "Combined4and5PassResiduals_WithDe0_WithToyErrors.csv"
...
def main() -> None:
    ...
    with summary_csv.open("w", newline="") as f:
        ...
        writer.writerow(["method", "combined_4and5_with_global_de0_scipy_nelder_mead_toy_errors"])
    ...
    print(f"[INFO] combined 4+5 with de0 physical toy fraction: {float(np.mean(physical_mask)):.4f}")
