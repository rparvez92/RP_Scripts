...
//
// Default paths:
//   results/tables/SimultaneousDpeOnly.csv
//   results/PNGs/PlotSimultaneousDpeOnly
//
// Example:
//   root -l -b -q 'macros/PlotSimultaneousDpeOnly.C()'
//   root -l -b -q 'macros/PlotSimultaneousDpeOnly.C("results/tables/SimultaneousDpeOnly.csv","results/PNGs/PlotSimultaneousDpeOnly")'
//
...
void PlotSimultaneousDpeOnly(const char* inCsvIn = "",
  ...
  if (inCsv.empty()) {
    inCsv = "results/tables/SimultaneousDpeOnly.csv";
  }

  std::string outDir = Trim(outDirIn ? outDirIn : "");
  if (outDir.empty()) {
    outDir = "results/PNGs/PlotSimultaneousDpeOnly";
  }
