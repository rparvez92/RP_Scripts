...
//
//   results/PNGs/PlotSimultaneousDpeDthe/<Constrained,Unconstrained>/setting<A,B>_kinOffsets.png
//   results/PNGs/PlotSimultaneousDpeDthe/<Constrained,Unconstrained>/setting<A,B>_residuals.png
//   results/PNGs/PlotSimultaneousDpeDthe/<Constrained,Unconstrained>/setting<A,B>_chi2ndf.png
//
// Plot types:
...
//   constrained:
//     results/tables/SimultaneousDpeDthe_constrained.csv
//     results/PNGs/PlotSimultaneousDpeDthe/Constrained
//
//   unconstrained:
//     results/tables/SimultaneousDpeDthe_unconstrained.csv
//     results/PNGs/PlotSimultaneousDpeDthe/Unconstrained
//
// Example:
//   root -l -b -q 'macros/PlotSimultaneousDpeDthe.C("constrained")'
//   root -l -b -q 'macros/PlotSimultaneousDpeDthe.C("unconstrained")'
//   root -l -b -q 'macros/PlotSimultaneousDpeDthe.C("constrained","results/tables/SimultaneousDpeDthe_constrained.csv","results/PNGs/PlotSimultaneousDpeDthe/Constrained")'
...
static void MakeOffsetsCanvas(const std::string& setting,
  ...
  TCanvas* c = new TCanvas(Form("c_sim_dpdt_kin_%s_%s", setting.c_str(), modeLabel.c_str()),
...
static void MakeResidualsCanvas(const std::string& setting,
                                ...
                                const std::string& outDir,
                                const std::string& modeLabel) {
  TCanvas* c = new TCanvas(Form("c_sim_dpdt_res_%s_%s", setting.c_str(), modeLabel.c_str()),
...
static void MakeChi2Canvas(const std::string& setting,
                           ...
                           const std::string& outDir,
                           const std::string& modeLabel) {
  TCanvas* c = new TCanvas(Form("c_sim_dpdt_chi2_%s_%s", setting.c_str(), modeLabel.c_str()),
...
void PlotSimultaneousDpeDthe(const char* modeIn = "unconstrained",
                             const char* inCsvIn = "",
                             const char* outDirIn = "") {
  ...
  if (inCsv.empty()) {
    inCsv = "results/tables/SimultaneousDpeDthe_" + mode + ".csv";
  }

  std::string outDir = Trim(outDirIn ? outDirIn : "");
  if (outDir.empty()) {
    outDir = "results/PNGs/PlotSimultaneousDpeDthe/" + modeDir;
  }
