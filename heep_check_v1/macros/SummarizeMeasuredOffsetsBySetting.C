// SummarizeMeasuredOffsetsBySetting.C
//
// Purpose:
//   Read heep_check_dpBinnedOffsets.csv and summarize measured offsets
...
//
// Example:
//   root -l -b -q 'SummarizeMeasuredOffsetsBySetting.C+(
...
void SummarizeMeasuredOffsetsBySetting(
    const char* inCsvC  = "results/tables/heep_check_dpBinnedOffsets.csv",
    const char* outCsvC = "results/tables/heep_check_offsetSummary_bySetting.csv") {
  ...
  fout
    ...
    << "mean_dmu_MeV,rms_dmu_MeV,sem_dmu_MeV,"
