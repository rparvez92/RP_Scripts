                  ...
                  bool saveTables = true)
{
  ...
  const TString simWeightExpr = Form("Weight*%e", simNormalizationFactor);
  ...
  // Draw panels
  double yMax = (globalYmax > 0) ? globalYmax * 1.25 : 1.0;
