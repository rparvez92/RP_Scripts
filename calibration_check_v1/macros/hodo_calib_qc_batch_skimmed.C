...
//
// Usage examples:
//   root -l -b -q 'hodo_calib_qc_batch_skimmed.C+("hms","./ROOTfiles","6126,6128-6130")'
//   root -l -b -q 'hodo_calib_qc_batch_skimmed.C+("shms","./ROOTfiles","24017-24025")'
//   root -l -b -q 'hodo_calib_qc_batch_skimmed.C+("coin","./ROOTfiles","6126,6127")'
// Run command example for using run lists
//   root -l -b -q 'hodo_calib_qc_batch_skimmed.C+("coin","./Skimmed_ROOTfiles")'
//   root -l -b -q 'hodo_calib_qc_batch_skimmed.C+("hms","./Skimmed_ROOTfiles")'
...
//--------------------------------------------------------------
void hodo_calib_qc_batch_skimmed(const char *Spec="", const char *RootDir="", const char *RunsList=""){
